<?php $pageTitle = 'Central de Pedidos Escolares'; ?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                <div class="text-center mb-4">
                    <h1 class="h3 mb-1"><?= icon('book', '24', '24', 'me-1') ?>Central de Pedidos</h1>
                    <p class="text-muted mb-0">Secretaria de Educação</p>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <form method="post" action="/login">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                                <label class="form-label" for="email">Usuário / e-mail</label>
                ...
                <p class="text-center text-muted small mt-3 mb-0">
                    Acesso exclusivo para escolas cadastradas.
                </p>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        fetch('/recuperar-senha', { method: 'POST', body: fd })
            .then(function (resp) {
